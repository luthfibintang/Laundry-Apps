 ...
 * @author Luthfi
 */
public class PetugasDashboard extends javax.swing.JFrame {
    ...
    public PetugasDashboard(String username) {
        initComponents();
    ...
    private void countOrderByStatus(){
        try {
            String queryUnconfirm = "SELECT COUNT(*) FROM `order` WHERE status = 'Menunggu Konfirmasi'";
            String queryInProgress = "SELECT COUNT(*) FROM `order` WHERE status != 'Menunggu Konfirmasi' AND status != 'Selesai' AND status != 'Ditolak'";
            String queryFinish = "SELECT COUNT(*) FROM `order` WHERE status = 'Selesai'";
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 130, 60));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 650, 210));
        ...
        jLabel6.setText("Status Laundry Order");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PetugasDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
