...
public class AddServiceForm extends javax.swing.JFrame {
    ...
    public AddServiceForm(String username) {
        initComponents();
    ...
    private void addService() {
        ...
        try {
            ...
            if(price.isEmpty() || serviceName.isEmpty()){
                JOptionPane.showMessageDialog(this, "Tolong isi semua input", "Try Again", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            pst = con.prepareStatement("INSERT INTO `services` (jenis, harga) VALUES (?,?)");
            pst.setString(1, serviceName);
            pst.setString(2, price);
            
            pst.executeUpdate();
            JOptionPane.showMessageDialog(this, "Berhasil menambahkan Layanan", "Success", JOptionPane.INFORMATION_MESSAGE);
            new OwnerDashboard(username).setVisible(true);
            this.dispose();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Error saat menyimpan Layanan: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        btnAddUser.setText("Tambah Service");
