...
public class UpdateForm extends javax.swing.JFrame {
    ...
    public UpdateForm(String username, int userId) {
        initComponents();
    ...
    private void updateOrder() {
        ...
        try {
            ...
            pst = con.prepareStatement("UPDATE `order` SET fullname=?, telp=?, alamat=?, id_services=?, berat=?, harga=?, ongkir=?, total_bayar=? WHERE id_order=?");
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 150, 50));
        ...
        jPanel3.add(btnAutoFill, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 23, -1, 30));
        ...
        btnUpdate.setBackground(new java.awt.Color(102, 127, 255));
        ...
        jPanel4.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 670, 30));
